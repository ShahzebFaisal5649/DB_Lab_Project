-- EDU-Connect Local Database Setup Script
-- Run this as MySQL root user after installing MySQL Server
-- In MySQL Workbench: File > Open SQL Script > run this file
-- Or in CLI: mysql -u root -p < setup-db.sql
...
CREATE USER IF NOT EXISTS 'edu_connect_user'@'localhost' IDENTIFIED BY 'edu_connect_pass';
...
SELECT 'EDU-Connect database setup complete!' AS status;
